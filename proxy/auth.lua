...
local permissions = {
    ...
    ["/cinema/schedules"] = { permission = "WRITE_MOVIE_SCHEDULE", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/cinema/schedules/"] = { permission = "WRITE_MOVIE_SCHEDULE", role = { "ADMIN", "MANAGER" } },
    ["/cinema/schedules/details/{id}"] = { permission = "READ_MOVIE_SCHEDULES", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/booking/{id}"] = { permission = "READ_BOOKING", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/booking"] = { permission = "WRITE_BOOKING", role = { "ADMIN", "CUSTOMER" } },
    ["/upload"] = { permission = "UPLOAD_FILE", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
}
