...
local permissions = {
    ...
    ["/user/{id}"] = { permission = "READ_USER", role = { "ADMIN", "MANAGER" } },
    ["/user"] = { permission = "WRITE_USER", role = { "ADMIN", "MANAGER" } },
    ["/user/existed/{id}"] = { permission = "READ_USER", role = { "ADMIN", "MANAGER" } },
    ["/cinema/auditoriums"] = { permission = "READ_AUDITORIUMS", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/cinema/auditorium"] = { permission = "WRITE_AUDITORIUM", role = { "ADMIN" } },
    ["/cinema/auditorium/{id}"] = { permission = "READ_AUDITORIUM", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/cinema/seats"] = { permission = "READ_SEATS", role = { "ADMIN", "CUSTOMER" } },
    ["/cinema/seat"] = { permission = "WRITE_SEAT", role = { "ADMIN", "MANAGER" } }, 
    ["/cinema/seat/{id}"] = { permission = "READ_SEAT", role = { "ADMIN", "MANAGER", "CUSTOMER" } }, 
    ["/cinema/seat/check/{id}"] = { permission = "READ_SEAT", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/cinema/seat/reserve/{id}"] = { permission = "WRITE_SEAT_RESERVE", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/cinema/movies"] = { permission = "READ_MOVIES", role = { "ADMIN", "MANAGER", "CUSTOMER" } }, 
    ["/cinema/movie"] = { permission = "WRITE_MOVIE", role = { "ADMIN", "MANAGER" } }, 
    ["/cinema/movie/{id}"] = { permission = "READ_MOVIE", role = { "ADMIN", "MANAGER", "CUSTOMER" } },
    ["/cinema/movie-schedule"] = { permission = "WRITE_MOVIE_SCHEDULE", role = { "ADMIN", "MANAGER" } },
