                  ...
                  >
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: t("messages.required.username"),
                        },
                      ]}
                    >
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: t("messages.required.email"),
                        },
                      ]}
                    >
                      <Input className="app-input" />
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: t("messages.required.password"),
                        },
                      ]}
                    >
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: t("messages.required.first_name"),
                        },
                      ]}
                    >
                      <Input className="app-input" />
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: t("messages.required.last_name"),
                        },
                      ]}
                    >
                      <Input className="app-input" />
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: t("messages.required.phone_number"),
                        },
                      ]}
                    >
                      <Input className="app-input" />
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: t("messages.required.date_of_birth"),
                        },
                      ]}
                    >
                      <DatePicker
